...
export function FlowerModal({ isOpen, onClose }: FlowerModalProps) {
  ...
  return (
    <div className="flower-modal-overlay" onClick={onClose}>
      <div className="flower-modal-content" onClick={(e) => e.stopPropagation()}>
        <button
        ...
        <div className="flower-modal-message">
          <h2 className="flower-modal-title">
            Ya llegará el día que llenemos nuestro jardín con las flores que quieras.
          </h2>
          <p className="flower-modal-subtitle">Feliz 5 meses amor de mi vida</p>
        </div>

        <div className={`flower-animation-container ${!isLoaded ? 'not-loaded' : ''}`}>
          ...
          <div className="flowers">
            ...
            {[0, 1, 2, 3, 4, 5, 6, 7].map((index) => (
              <div key={`long-g-${index}`} className={`long-g long-g--${index}`}>
